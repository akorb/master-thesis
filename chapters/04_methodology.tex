...
The DICE Certificate Profiles \cite{DICE_certs} defines the requirements for various certificate types.
Our certificate is an attestation certificate in this specification.
...
However, it is irrelevant for us, since the EK certificate specification does not define any own X.509 fields.
...
Another property which can affect the requirement of our certificate is its further usage.
Our EK certificate is a leaf of the certificate chain.
...
Therefore, %we omit this extension because
if a verifier trusts a TCI, he should also know which manufacturer, exact code and TPM specification it conforms to.
