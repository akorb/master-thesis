...
In their DICE Attestation Architecture \cite{TCGAttestation2020}, they define an X.509 extension that contains the TCIs.
In fact, however, they still refer to them as FWIDs in its formal definition, while everywhere else they are referred to as TCIs.
