...
% So far, the fTPM is strictly bound to the processor manufacturer, like Intel® NUC-Kit NUC7PJYH (Intel® Platform Trust Technology), such that you can trust the underlying software as well which is provisioned by the manufacturer, e.g., Intel, too.
