...
\begin{enumerate}
  ...
  % To reduce attack surface, simpler to protect
  ...
  % Data is only accessible via TPM defined 
  % against other TA's, since they can know the fTPM's UUID
  ...
  % Note that this contradicts goal~\ref{enum:tpm-id}, which is why we will discuss this separately later.
  }
\end{enumerate}
