...
% Big advantage of fTPM is that it doesn't require additional hardware, except for TEE which is already ubiquotious.
% But DICE involves hardware requirements.
% The question is naheliegend whether it even makes sense, then.
