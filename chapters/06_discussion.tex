...
This is usually implemented in latches as part of the processor which block access to a specific memory area after a bit has been set~\cite{Lorych2022}, e.g., by the STM32G0 based on the Arm Cortex-M0+ or the STM32L4 based on the Arm Cortex-M4~\cite{Lorych2022}.
